...
module.exports = Promise.resolve()
    ...
    .then(function () { return import('hello-world/lib/browser/hello-world-frontend-module').then(load) })
    .then(function () { return import('reflex-language-server/lib/browser/language-server-frontend-module').then(load) })
